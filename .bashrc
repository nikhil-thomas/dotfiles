...
source ~/.env-var/.minishift

export MINISHIFT_GITHUB_API_TOKEN
...
alias occu="oc cluster up --host-config-dir=$(pwd)/config-dir --host-data-dir=$(pwd)/date-dir --host-pv-dir=$(pwd)/pv-dir --host-volumes-dir=$(pwd)/volumes"
...
export SDKMAN_DIR="/home/nikhil/.sdkman"
[[ -s "/home/nikhil/.sdkman/bin/sdkman-init.sh" ]] && source "/home/nikhil/.sdkman/bin/sdkman-init.sh"
export JAVA_HOME=/home/nikhil/.sdkman/candidates/java/current
